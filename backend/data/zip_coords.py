"""Zip code to lat/lon centroid mapping.

Covers major US zip codes. For a hackathon, we include a representative sample
and fall back to state capitals for unknown zips.
"""
...
# State capital coordinates as fallbacks
STATE_CAPITALS = {
    "AL": (32.377, -86.300), "AK": (58.302, -134.420), "AZ": (33.449, -112.074),
    "AR": (34.746, -92.290), "CA": (38.576, -121.494), "CO": (39.739, -104.985),
    "CT": (41.764, -72.683), "DE": (39.158, -75.525), "FL": (30.438, -84.281),
    "GA": (33.749, -84.388), "HI": (21.307, -157.858), "ID": (43.615, -116.202),
    "IL": (39.798, -89.654), "IN": (39.768, -86.158), "IA": (41.591, -93.604),
    "KS": (39.049, -95.678), "KY": (38.187, -84.875), "LA": (30.457, -91.187),
    "ME": (44.307, -69.782), "MD": (38.979, -76.491), "MA": (42.358, -71.064),
    "MI": (42.733, -84.555), "MN": (44.955, -93.102), "MS": (32.299, -90.185),
    "MO": (38.579, -92.173), "MT": (46.586, -112.018), "NE": (40.808, -96.700),
    "NV": (39.164, -119.766), "NH": (43.207, -71.538), "NJ": (40.221, -74.756),
    "NM": (35.682, -105.940), "NY": (42.653, -73.757), "NC": (35.780, -78.639),
    "ND": (46.813, -100.779), "OH": (39.962, -83.001), "OK": (35.473, -97.517),
    "OR": (44.938, -123.030), "PA": (40.264, -76.884), "RI": (41.824, -71.413),
    "SC": (34.000, -81.035), "SD": (44.368, -100.350), "TN": (36.166, -86.784),
    "TX": (30.275, -97.740), "UT": (40.758, -111.876), "VT": (44.260, -72.576),
    "VA": (37.541, -77.434), "WA": (47.043, -122.893), "WV": (38.349, -81.633),
    "WI": (43.075, -89.384), "WY": (41.140, -104.820), "DC": (38.907, -77.037),
}

# Zip prefix (first 3 digits) to approximate state mapping
ZIP_PREFIX_TO_STATE = {
    ...
    "200": "DC", "201": "VA", "202": "DC", "203": "DC", "204": "DC", "205": "WV",
    ...
    "297": "GA", "298": "GA", "299": "GA", "300": "GA", "301": "GA", "302": "GA", "303": "GA", "304": "GA", "305": "GA", "306": "GA",
    "307": "GA", "308": "GA", "309": "GA", "310": "GA", "311": "GA", "312": "GA", "313": "GA", "314": "GA", "315": "GA", "316": "GA",
    "317": "GA", "318": "GA", "319": "GA",
...
def zip_to_state(zip_code: str) -> str:
    prefix = zip_code[:3]
    return ZIP_PREFIX_TO_STATE.get(prefix, "CA")


def zip_to_coords(zip_code: str) -> tuple[float, float]:
    """Get approximate lat/lon for a zip code using free Zippopotam.us API, with state capital fallback."""
    if zip_code in _zip_cache:
        return _zip_cache[zip_code]

    # Try free geocoding API
    try:
        resp = requests.get(f"https://api.zippopotam.us/us/{zip_code}", timeout=3)
    ...
    coords = STATE_CAPITALS.get(state, (37.77, -122.42))
    _zip_cache[zip_code] = coords
    return coords
