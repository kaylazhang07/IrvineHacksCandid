...
import { getCategoryColor, prettifyTitle, stateDisplayName, zipToStateAbbr } from '@/lib/utils';
    ...
    >
      ...
      <div className="px-6 py-5">
        ...
        <p className="text-sm text-slate-600 leading-relaxed">
          {measure.summary || 'Select "View Full Analysis" for a detailed plain-English breakdown.'}
        </p>
      </div>
...
function SkeletonRow({ index }: { index: number }) {
  return (
    <div className="flex items-start gap-4 px-6 py-5 animate-pulse" style={{ animationDelay: `${index * 0.07}s` }}>
